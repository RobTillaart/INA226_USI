...
#include "Arduino.h"
//#include <Wire.h>                     // J.P.S.: replaced by next line for ATtiny85 (1)
#include <TinyWireM.h>
...
public:
 ...
 // explicit INA226(const uint8_t address, TwoWire *wire = &Wire);                     // J.P.S.: replaced by next line for ATtiny85 (2)
 explicit INA226(const uint8_t address, USI_TWI *wire = &TinyWireM);
...
private:
  ...
  uint8_t   _address;
  //TwoWire * _wire;                     // J.P.S.: replaced by next line for ATtiny85 (3)
  USI_TWI * _wire;
